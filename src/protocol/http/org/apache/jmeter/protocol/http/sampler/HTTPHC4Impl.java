...
public class HTTPHC4Impl extends HTTPHCAbstractImpl {
    ...
    static {
       ...
       /*if (CPS_HTTP > 0) {
        	//int testBT4 = 1024;
            log.info("Setting up HTTP SlowProtocol, cps="+rtoCPS);
            SLOW_HTTP = new Scheme(HTTPConstants.PROTOCOL_HTTP, HTTPConstants.DEFAULT_HTTP_PORT, new SlowHC4SocketFactory(rtoCPS));
        } else {
            SLOW_HTTP = null;
        }*/
    ...
    if (getUseKeepAlive()) {
        ...
        log.info("Connection Close set in the headers in HTTPHC4Impl.java");
    }
